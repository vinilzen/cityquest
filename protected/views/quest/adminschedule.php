...
<?	
	...
	for ($i=0; $i<30; $i++) {
		...
		echo '<a title="'.date('d M Y', $currDate).'" href="/quest/adminschedule/ymd/'.date('Ymd', $currDate).'" type="button" class="btn btn-sm btn-default'.$active.$weekend.'" '.$disabled.' >'.date('d', $currDate).'</a>';
	}
?>
</div>
<hr>
