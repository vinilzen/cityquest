...
<div class="col-sm-6">
	<p><br>Добавление/реадктирование квеста</p>
</div>
...
<button type="button" class="btn" data-toggle="collapse" data-target="#times-table">  Показать время на ближайшие две недели </button>
