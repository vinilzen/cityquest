...
<div class="row rules">
	...
	<? if (strpos($_SERVER['HTTP_HOST'], '.kz') > 0) { ?>
		<h1 class="h3 text-center">Сертификат на квест в Астане</h1>
		...
		<p>Карту можно приобрести у нас на квесте, либо воспользоваться доставкой.  Подробности Вы можете уточнить по телефону +7 (776) 100-4447</p>
		<p>Стоимость подарочной карты 12 000 т, стоимость доставки 900 т.</p>
	<? } else { ?>
		<h1 class="h3 text-center">Сертификат на квест в Москве</h1>
		<p>Вы можете подарить впечатления от наших квестов своим близким, друзьям и коллегам! Для этого достаточно приобрести нашу фирменную подарочную карту, действующую во всех локациях CityQuest.  Для того, чтобы воспользоваться картой, просто приносите ее с собой на игру.<br></p>
