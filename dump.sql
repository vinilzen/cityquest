...
--
-- Хост: localhost
-- Время создания: Июл 03 2014 г., 18:03
...
(4, 20140706, 3500, '', '28 июня - 14:00 - нус', 0, '14:00', 1403811758, NULL, '123-465-798', NULL, 2, 2),
...
(17, 20140706, 3000, '', '31 Jul - 06:30 - 2в2цвцув', 0, '06:30', 1404291672, NULL, '123-465-798', NULL, 2, 2),
...
(1, 'Темница Ивана Грозного', '"Замуровали демоны!" - знакомая всем с детства фраза принимает в этом комнате буквальный характер. Вас ждут мистические темницы подземелья из смутного времени, чтобы выбраться из которых, вам прийдется познакомиться с различными орудиями пыток тех лет, а также вспомнить классику советского кинематографа.', 'Малая Тульская улица д.2/1 к5', 'Тульская ', 2, 3, 1403167567, 1404389748, 1, 1, 2),
(2, 'Нехорошая квартира', 'В этой квартире переплелись не только судьбы персонажей книги Булгакова, но еще пространство и время. Чтобы выбраться из очень атмосферного помещения игрокам предстоит распутать этот сложный клубок загадок, а возможно и познакомиться с самим Воландом!', ' Малая Тульская улица д.2/1 к5', 'Тульская', 3, 2, 4, 1404389748, 1, 1, 0),
(3, 'Ограбление банка', 'Описание ограбления ', 'Ульяновская 45', 'Партизанская', 1, 2, 1404222436, 1404389748, 1, 1, 1);
